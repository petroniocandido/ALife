...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelector("#stop_boids");
      if (t1 != null) {
    ...
    boids_animation(timestamp) {
      var canvas, t1, t2, canvasWidth, canvasHeight, t3, t4, _i, boid, t5;
      A._asNum(timestamp);
  ...
  A.Boid.prototype = {
    toString$0(_) {
      return "(" + this._position.toString$0(0) + ", " + this._direction.toString$0(0) + ")";
    }
  };
  A.BoidSimulation.prototype = {
    ...
    neighbors$1(boid) {
      var t1, t2, j, t3, t4, _this = this,
        ix = A._setArrayType([], type$.JSArray_Boid);
      for (t1 = boid._id, t2 = _this._distances, j = 0; j < _this._boids.length; ++j) {
        if (j !== t1) {
          t3 = t2.$index(0, t1);
          t3 = t3 == null ? null : t3.$index(0, j);
          if (t3 == null)
            t3 = 0;
          t4 = _this._radius;
          if (typeof t3 !== "number")
        ...
        if (t3) {
          ...
          if (!(j < t3.length))
            return A.ioore(t3, j);
          B.JSArray_methods.add$1(ix, t3[j]);
        }
      }
      return ix;
    },
    ...
    separation$2(obj, sim) {
      ...
      for (t1 = neigh.length, _i = 0; _i < t1; ++_i) {
        ...
        obj._direction = new A.Point2D(t2._x - t4, t2._y - t3);
      }
      return obj;
    },
    move$2(obj, sim) {
    ...
    mapDistances$0() {
      var t1, t2, t3, i, t4, boidA, j, j0, boidB, t5, d;
      for (t1 = this._distances, t2 = type$.int, t3 = type$.double, i = 0; t4 = this._boids, i < t4.length; i = j) {
        boidA = t4[i];
        t1.$indexSet(0, boidA._id, A.LinkedHashMap_LinkedHashMap$_empty(t2, t3));
        t4 = t1.$index(0, i);
        if (t4 != null)
          t4.$indexSet(0, i, -1);
        for (j = i + 1, j0 = j; t4 = this._boids, j0 < t4.length; ++j0) {
          boidB = t4[j0];
          t4 = boidA._position;
          t5 = boidB._position;
    ...
    next$0() {
      var t2, t3, _i, boid, t4, _i0, _this = this,
        t1 = _this._boids;
      t1 = A._setArrayType(t1.slice(0), A._arrayInstanceType(t1));
      _this.set$_workingBoids(t1);
      _this.mapDistances$0();
      _this._swarmMidPoint = _this.midPoint$1(_this._boids);
      for (t1 = _this._workingBoids, t2 = t1.length, t3 = _this._actions, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        boid = t1[_i];
      ...
      t1 = _this._workingBoids;
      t1 = A._setArrayType(t1.slice(0), A._arrayInstanceType(t1));
      _this.set$_boids(t1);
    },
    set$_boids(_boids) {
      this._boids = type$.List_Boid._as(_boids);
    },
    set$_workingBoids(_workingBoids) {
      this._workingBoids = type$.List_Boid._as(_workingBoids);
    }
  };
  A.Point2D.prototype = {
    $add(_, obj) {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      A.changeLabel("num_boids", "lbl_num_boids");
    },
    $signature: 1
  };
  A.main_closure0.prototype = {
    call$1($event) {
      A.changeLabel("velocity", "lbl_velocity");
    },
    $signature: 1
  };
  ...
  A.main_closure2.prototype = {
    call$1($event) {
      ...
      t2 = canvas == null;
      canvasWidth = t2 ? _null : canvas.width;
      if (canvasWidth == null)
        canvasWidth = 100;
      canvasHeight = t2 ? _null : canvas.height;
      if (canvasHeight == null)
        canvasHeight = 100;
      ...
      t1._radius = A.double_parse(t2 == null ? "20" : t2);
      $.$get$simulation().initialize$0();
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Boid: findType("Boid"),
      BoidSimulation: findType("BoidSimulation"),
      Error: findType("Error"),
      Event: findType("Event"),
      Function: findType("Function"),
      Future_dynamic: findType("Future<@>"),
      JSArray_Boid: findType("JSArray<Boid>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_dynamic: findType("JSArray<@>"),
      JSArray_of_Boid_Function_Boid_BoidSimulation: findType("JSArray<Boid(Boid,BoidSimulation)>"),
      JSNull: findType("JSNull"),
      JavaScriptFunction: findType("JavaScriptFunction"),
      List_Boid: findType("List<Boid>"),
...
//# sourceMappingURL=boids_controller.js.map
