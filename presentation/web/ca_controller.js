...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    ca1d_animation_boxes(timestamp) {
      ...
      if (t3._iteration <= t4) {
        ...
        $.animation_request_id = B.Window_methods.requestAnimationFrame$1(window, A.ca_controller__ca1d_animation_boxes$closure());
      }
    },
  ...
  A.main_closure1.prototype = {
    call$1($event) {
      var t1, w_ele, t2, w, sel, options, key;
      ...
      t1 = options.toList$0(options);
      t2 = sel.selectedIndex;
      if (t2 == null)
        t2 = 0;
      if (!(t2 >= 0 && t2 < t1.length))
        return A.ioore(t1, t2);
      key = t1[t2].value;
      t2 = A.SimpleCellularAutomata1D$(w, type$.Map_String_dynamic._as($.rules.$index(0, key)));
      $.ca = t2;
      t2.initialize$0();
      B.Window_methods.requestAnimationFrame$1(window, A.ca_controller__ca1d_animation_boxes$closure());
    },
    $signature: 1
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "ca_controller__ca1d_animation_boxes$closure", "ca1d_animation_boxes", 3);
